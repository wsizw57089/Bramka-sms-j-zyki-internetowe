	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="green">
	                                <h4 class="title">Baza studentów</h4>
	                            ...
	                            <div class="card-content table-responsive">
									...
									<table id="demo">
										...
										<tbody>
										<form method="POST" action="odbiorcy_studenci.php">
										<?php
											try
											{
												$pdo = $connect;
												$pdo -> query ('SET NAMES utf8');
												$stmt = $pdo->query("SELECT * FROM studenci");
												foreach($stmt as $row)
												{
													echo "<tr>"; 
													...
													echo "<td>".$row['rok']."</td>"; 
													echo "<td><a href='student.php?album=".$row['album']."'><button type='button' class='btn btn-success'>Historia</button></a></td>"; 
													echo "</tr>"; 
												}
												$stmt->closeCursor();	  
											}
