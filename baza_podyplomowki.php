...
<head>
	...
	<title>Baza Podyplomowe - BRAMKA SMS PWSZ TARNOBRZEG</title>
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="green">
	                                <h4 class="title">Baza podyplomowe</h4>
	                            ...
	                            <div class="card-content table-responsive">
									...
									<table id="demo">
										...
										<tbody>
										<form method="POST" action="odbiorcy_podyplomowe.php">
										<?php
											try
											{
												$pdo = $connect;
												$pdo -> query ('SET NAMES utf8');
												$stmt = $pdo->query("SELECT * FROM studia_podyplomowe");
												foreach($stmt as $row)
												{
													echo "<tr>"; 
													echo "<td><label><input class='checkbox' type='checkbox' name='album[]' value=".$row['numer_sluchacza'].">".$row['numer_sluchacza']."</label>";
													echo "<td>".$row['imie']."</td>"; 
													echo "<td>".$row['nazwisko']."</td>"; 
													echo "<td>".$row['kierunek']."</td>"; 
													echo "<td>".$row['rok']."</td>"; 
													echo "<td><a href='podyplomowe.php?album=".$row['numer_sluchacza']."'><button type='button' class='btn btn-success'>Historia</button></a></td>"; 
													echo "</tr>"; 
												}
												$stmt->closeCursor();	  
											}
