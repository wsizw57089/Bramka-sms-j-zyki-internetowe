...
<head>
	...
	<title>Odbiorcy studenci - BRAMKA SMS PWSZ TARNOBRZEG</title>
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="blue">
	                                <h4 class="title">Wiadomość do studentów</h4>
												...
												echo "	<thead>";
													...
													echo "<tbody>";
														...
														try
														{
															...
															$stmt = $pdo->query("SELECT * FROM studenci WHERE album IN ($album)");
															foreach($stmt as $row)
															{
																echo "<tr>"; 
																$album_s[] = $row['album'];
														...
														echo "</div>";
														echo "<center><a href='baza_studenci.php'><button type='button' class='btn btn-success'>Wróć do bazy</button></a>
